...
INSERT INTO HOSPEDE (NOME, DT_NASC, NAC)
VALUES ('CHICA', '2016-01-03', 'BRASILEIRA');

SELECT HP.NOME , HG.NUM_AP, COUNT(HG.COD_HOSPEDAGEM) AS  QUANTIDADE
FROM HOSPEDE AS HP 
JOIN HOSPEDAGEM AS HG ON HP.COD_HOSP = HG.COD_HOSP
GROUP BY HP.COD_HOSP, HG.NUM_AP
